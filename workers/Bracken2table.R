...
#Ponsero Alise 2024
#Version  DRAFT
#This script takes a Bracken report file or a directory containing Bracken report 
# files and wrangle them into an easy to parse data format.
########## 
#usage: kraken2table.R [-h] [-i INPUT] [-t INPUT_TYPE] [-n FILES_NAMES] [-p]
#                    [--verbose] [--quietly]
#Bracken reports to table parser
#required arguments:
#  -i, --input : Bracken report input file
#optional arguments:
#  -t,  --input_type : Type of input provided: file|dir [default=file]
#  -n,  --files_names : Extensions of the Bracken files to parse [default=_profiles_bracken_genuses.txt]
...
parser$add_argument("-i", "--input", type="character", required=TRUE, 
                    help="path to Bracken report file or to directory to parse",
                    metavar="input")
# Optional arguments
parser$add_argument("-t", "--input_type", type="character", default="file", 
                    help="Type of input profided: file|dir [default=file]",
                    metavar="input_type")
parser$add_argument("-n", "--files_names", type="character", default="_profiles_bracken_genuses.txt", 
                    help="extensions of the Bracken files to parse [default=_profiles_bracken_genuses.txt]",
                    metavar="files_names")
